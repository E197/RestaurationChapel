...
public class RestaurationChapelApp {

    private static final Logger log = LoggerFactory.getLogger(RestaurationChapelApp.class);

    private final Environment env;

    public RestaurationChapelApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes RestaurationChapel.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RestaurationChapelApp.class);
